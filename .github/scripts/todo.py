class Task: 
  ...
  def __init__(self, titlem status+"ToDo"):
      self.title = title
...
class TaskPool: 
  ...
  def populate(self):
    ...
    task4 = Task("Update login UI", status="Done)
    task5 = Task("Update documentation", status="Done)
    task6 = Task("Deploy to production", status="Done)
